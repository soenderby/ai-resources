...
| [maintain](maintain/) | Run repo maintenance: sync index.md, check for broken cross-links, unlinked authors, missing separators. |
| [repo-query](repo-query/) | Query a local markdown knowledge repository for matching concepts, source entries, and synthesis sections. |
